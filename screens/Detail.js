...
const StarReview = ({ rate }) => {
    ...
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            {starComponents}
            <Text style={{ marginLeft: 8, color: "#8b9097", fontSize:16, lineHeight:22 }}>{rate}</Text>
        </View>
    )
}
...
const IconLabel = ({ icon, label }) => {
    return (
        <View style={{ alignItems: 'center' }}>
            ...
            />
            <Text style={{ marginTop: 24, color:"#8b9097" , fontSize:16,lineHeight:22}}>{label}</Text>
        </View>
    )
}
        ...
        <View style={styles.container}>
                ...
                >
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={{ marginHorizontal: 12, justifyContent: 'space-around' }}>
                            <Text style={{fontSize:16,lineHeight:22 }}>Ski Villa</Text>
                            <Text style={{ color:"#8b9097", fontSize:16,lineHeight:22 }}>France</Text>
            ...
            <View style={{ flex: 1.5 }}>
                ...
                <View style={{ marginTop: 24, paddingHorizontal: 24 }}>
                    <Text style={{ fontSize:22,lineHeight:30 }}>About</Text>
                    <Text style={{ marginTop: 12, color: "#8b9097", fontSize:16,lineHeight:22 }}>
                ...
                >
                    <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                        <View style={{ flex: 1, marginHorizontal: 24, justifyContent: 'center' }}>
                            <Text style={{ fontSize:30,lineHeight:36 }}>$1000</Text>
                        </View>
                        ...
                        >
                            ...
                            >
                                <Text style={{ color: "white", fontSize:22,lineHeight:30 }}>BOOKING</Text>
                            </LinearGradient>
                        </TouchableOpacity>
                    </View>
                </LinearGradient>
